...
//        Log.e("GPURender", "Ratio: w- " + ratioWidth + " :: h- " + ratioHeight);
        ...
        } else if (scaleType == GPUImage.ScaleType.CENTER_FIT) {
            float ratio = Math.max(ratioWidth, ratioHeight);
            Log.e("GPURender", "Ratio: " + ratioWidth + " :: " + ratioHeight);
            cube = new float[]{
                    CUBE[0] / ratio, CUBE[1] / ratio,
                    CUBE[2] / ratio, CUBE[3] / ratio,
                    CUBE[4] / ratio, CUBE[5] / ratio,
                    CUBE[6] / ratio, CUBE[7] / ratio,
            };
        } else {
            cube = new float[]{
