...
import com.plugin.filters.plugin_filters.mlkit.ScopedExecutor
...
import com.plugin.filters.plugin_filters.mlkit.graphic.InferenceInfoGraphic
...
abstract class VisionProcessorBase<T>(context: Context) : VisionImageProcessor {
    ...
    private fun setUpListener(
        ...
        return task
            .addOnSuccessListener(
                ...
                if (!PreferenceUtils.shouldHideDetectionInfo(graphicOverlay.context) && BuildConfig.DEBUG) {
                    graphicOverlay.add(
    ...
    protected abstract fun detectInImage(image: InputImage, cameraImage: Bitmap? = null): Task<T>
